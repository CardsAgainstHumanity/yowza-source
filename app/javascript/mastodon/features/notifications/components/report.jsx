    ...
    return (
      <div className='notification__report'>
        ...
        <div className='notification__report__details'>
          <div>
            <RelativeTimestamp timestamp={report.get('created_at')} short={false} /> · <FormattedMessage id='report_notification.attached_statuses' defaultMessage='{count, plural, one {# yowza} other {# yowzas}} attached' values={{ count: report.get('status_ids').size }} />
            <br />
