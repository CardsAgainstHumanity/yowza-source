    ...
    return (
      <div className='modal-root__modal report-dialog-modal'>
        ...
        <div className='report-dialog-modal__container'>
          <p className='report-dialog-modal__lead'><FormattedMessage id='subscribed_languages.lead' defaultMessage='Only yowzas in selected languages will appear on your home and list timelines after the change. Select none to receive yowzas in all languages.' /></p>
