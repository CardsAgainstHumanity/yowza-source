        ...
        <>
          ...
          <p className='report-dialog-modal__lead'>
            <FormattedMessage
              ...
              defaultMessage='This filter category does not apply to the context in which you have accessed this yowza. If you want the yowza to be filtered in this context too, you will have to edit the filter.'
            />
          </p>
        </>
      );
      ...
      <>
        ...
        <p className='report-dialog-modal__lead'>
          <FormattedMessage
            ...
            defaultMessage='This yowza has been added to the following filter category: {title}.'
