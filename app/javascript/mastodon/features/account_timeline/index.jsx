...
const RemoteHint = ({ url }) => (
  <TimelineHint url={url} resource={<FormattedMessage id='timeline_hint.resources.statuses' defaultMessage='Older yowzas' />} />
);
...
class AccountTimeline extends ImmutablePureComponent {
  ...
  render () {
    ...
    if (suspended) {
      ...
      emptyMessage = <FormattedMessage id='empty_column.account_timeline' defaultMessage='No yowzas found' />;
    }
