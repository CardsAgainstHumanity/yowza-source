...
class SearchResults extends ImmutablePureComponent {
  ...
  render () {
    ...
    if (results.get('statuses') && results.get('statuses').size > 0) {
      ...
      statuses = (
        <div className='search-results__section'>
          <h5><Icon id='quote-right' fixedWidth /><FormattedMessage id='search_results.statuses' defaultMessage='Yowzas' /></h5>
      ...
      statuses = (
        <div className='search-results__section'>
          ...
          <div className='search-results__info'>
            <FormattedMessage id='search_results.statuses_fts_disabled' defaultMessage='Searching yowzas by their content is not enabled on this Mastodon server.' />
          </div>
        </div>
      );
    }
