...
class Favourites extends ImmutablePureComponent {
  ...
  render () {
    ...
    const emptyMessage = <FormattedMessage id='empty_column.favourites' defaultMessage='No one has favorited this yowza yet. When someone does, they will show up here.' />;
